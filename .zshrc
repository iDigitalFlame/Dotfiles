...
################################
# SSH Aliases
alias lx-iot01="ssh -i ~/.sshkeys/root-iot01.losynth.com.ssh root@iot01.losynth.com"
alias lx-web01="ssh -i ~/.sshkeys/root-web01.losynth.com.ssh root@web01.losynth.com"
alias lx-web02="ssh -i ~/.sshkeys/root-web02.losynth.com.ssh root@web02.losynth.com"
alias lx-lsvm01="ssh -i ~/.sshkeys/root-lsvm01.losynth.com.ssh root@lsvm01.losynth.com"
alias lx-lsvm02="ssh -i ~/.sshkeys/root-lsvm01.losynth.com.ssh root@lsvm02.losynth.com"
alias lx-lsas01="ssh -i ~/.sshkeys/root-lsas01.losynth.com.ssh root@lsas01.losynth.com"
alias lx-lsac01="ssh -i ~/.sshkeys/root-lsac01.losynth.com.ssh root@lsac01.losynth.com"
alias lx-lsbk01="ssh -i ~/.sshkeys/root-lsbk01.losynth.com.ssh root@backup.losynth.com"
alias lx-mail01="ssh -i ~/.sshkeys/root-mail01.losynth.com.ssh root@mail01.losynth.com"
alias lx-data01="ssh -i ~/.sshkeys/root-data01.losynth.com.ssh root@data01.losynth.com"
...
alias smb-user="smb-connect losynth.com/eric //lsfs01.losynth.com/Users$/eric"
alias smb-programs="smb-connect losynth.com/eric //lsfs01.losynth.com/Programs$"
...
alias ts="xfreerdp /v:ts.losynth.com /size:100% +clipboard /u:eric /d:losynth.com /f"
...
#alias iw-mac="sudo ifconfig en0 ether $(openssl rand -hex 6 | sed 's%\(..\)%\1:%g; s%.$%%')"
#alias iw-reset-mac="sudo ifconfig en0 ether 78:4f:43:51:64:48"
#alias gitsync="git add .;git commit;git push"
#alias netproc="lsof -i -P -n | grep -i \"ESTABLISHED\""
#alias netproc-all="sudo lsof -i -P -n | grep -i \"ESTABLISHED\""
#alias connected="netstat -anvp tcp | grep -v TIME_WAIT | grep -v CLOSE | grep -v LISTEN | grep -v fe80 | grep -v 127.0.0.1"
